...
<body>
    <form id="Form2" runat="server">
        <div class="container">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Name is Required" ControlToValidate="nameInput" ForeColor="Red" Display="Dynamic" ValidationGroup="regngrp"></asp:RequiredFieldValidator>
            <div class="error-message" id="nameError"></div>

            <label for="familyNameInput">Family Name:</label>
            <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter Family Name" ControlToValidate="familyNameInput" ForeColor="Red" Display="Dynamic" ValidationGroup="regngrp"></asp:RequiredFieldValidator>
            <div class="error-message" id="familyNameError"></div>

            <label for="addressInput">Address:</label>
            <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter Address" ControlToValidate="addressInput" ForeColor="Red" Display="Dynamic" ValidationGroup="regngrp"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Address should have at least 2 characters." ControlToValidate="addressInput" ValidationExpression="^.{2,}$" ForeColor="Red" ValidationGroup="regngrp"></asp:RegularExpressionValidator>
            <div class="error-message" id="addressError"></div>

            <label for="cityInput">City:</label>
            <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Enter City" ControlToValidate="cityInput" ForeColor="Red" Display="Dynamic" ValidationGroup="regngrp"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="City should have at least 2 characters." ControlToValidate="cityInput" ValidationExpression="^.{2,}$" ForeColor="Red" ValidationGroup="regngrp"></asp:RegularExpressionValidator>
            <div class="error-message" id="cityError"></div>

            <label for="zipCodeInput">Zip Code:</label>
            <asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="Zip Code is required" ControlToValidate="zipCodeInput" ForeColor="Red" Display="Dynamic" ValidationGroup="regngrp"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Zip-code should be 5 digits." ControlToValidate="zipCodeInput" ValidationExpression="^\d{5}$" ForeColor="Red" ValidationGroup="regngrp"></asp:RegularExpressionValidator>
            <div class="error-message" id="zipCodeError"></div>

            <label for="phoneInput">Phone:</label>
            <asp:TextBox ID="TextBox6" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Zip Code is required" ControlToValidate="zipCodeInput" ForeColor="Red" Display="Dynamic" ValidationGroup="regngrp"></asp:RequiredFieldValidator>

            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="Phone should be in the format XX-XXXXXXXX or XXX-XXXXXXX." ControlToValidate="phoneInput" ValidationExpression="^\d{2,3}-?\d{7}$" ForeColor="Red" ValidationGroup="regngrp"></asp:RegularExpressionValidator>
            <div class="error-message" id="phoneError"></div>

            <label for="emailInput">E-Mail:</label>
            <asp:TextBox ID="TextBox7" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="Phone is required" ControlToValidate="phoneInput" ForeColor="Red" Display="Dynamic" ValidationGroup="regngrp"></asp:RequiredFieldValidator>

            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ErrorMessage="Invalid Email Format." ControlToValidate="emailInput" ValidationExpression="^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$" ForeColor="Red" ValidationGroup="regngrp"></asp:RegularExpressionValidator>
            <div class="error-message" id="emailError"></div>
            ...
            <asp:Button ID="Button1" runat="server" Text="Check" CssClass="submit-button" OnClick="btnSubmit_Click" ValidationGroup="regngrp" />
